	...
	return (
		<div className="container mx-auto pt-16">
			<div className="flex flex-row mb-14 justify-center items-center gap-2 w-full">
				<p className="text-xl font-semibold gray-600">Bill Monthly</p>
				<div className="cursor-pointer  w-12 h-6 rounded-full bg-gradient-to-r from-gr-1 via-gr-2 to-gr-3 relative shadow-sm">
					...
					<label
						...
						className="toggle-label  bg-gradient-to-r from-gr-1 via-gr-2 to-gr-3 block w-12 h-6 overflow-hidden rounded-full  cursor-pointer"
					/>
				</div>
				<p className="text-xl font-semibold gray-600">Bill Annually</p>
			</div>
			<div className="flex flex-wrap justify-between">
				<div className="w-11/12 xl:w-1/3 lg:w-1/2 sm:w-5/12 md:w-5/12 mx-auto mb-4 max-w-sm shadow rounded-lg border border-gray-300 sm:border-none bg-white">
					<div className="pt-8 px-8 pb-6">
						<h4 className="text-2xl text-center text-gray-600 pb-3 font-bold">
							Professional
						</h4>
					...
					>
						...
						<div className="cursor-pointer  w-12 h-6 rounded-full bg-gradient-to-r from-gr-1 via-gr-2 to-gr-3 relative shadow-sm">
							...
							<label
								...
								className="toggle-label   block w-12 h-6 overflow-hidden rounded-full bg-gradient-to-r from-gr-1 via-gr-2 to-gr-3 cursor-pointer"
							/>
						</div>
					</div>
					...
					<div className="flex justify-center pb-8">
						<button className="focus:outline-none bg-white hover:bg-gray-100 transition duration-150 ease-in-out  rounded border text-gray-600 shadow-md px-6 py-2 text-sm">
							Subscribe
						</button>
					</div>
				</div>
				<div className="w-11/12 xl:w-1/3 lg:w-1/2  sm:w-5/12 md:w-5/12 mx-auto mb-4 max-w-sm shadow rounded-lg border-2 border-gr-2  bg-white">
					<div className="pt-8 px-8 pb-6">
						<h4 className="text-2xl text-center text-gray-600 pb-3 font-bold">
							Pro Plus
						</h4>
					...
					<div className="flex justify-center pb-8">
						<button className="focus:outline-none text-transparent bg-clip-text bg-gradient-to-r from-gr-1 via-gr-2 to-gr-3 transition duration-150 ease-in-out  rounded  shadow-md px-6 py-2 text-sm">
							Subscribe
						</button>
					</div>
				</div>
